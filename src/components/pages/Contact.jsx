    ...
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4 text-gray-300'>
        <form action="https://getform.io/f/a2241859-20af-4fc7-a9ff-dbd6891cfa39" className='flex flex-col max-w-[600px] w-full t' method='POST'>
            <div className='pb-8'>
                ...
                <p className='py-4'>// Submit the form bellow or shoot me an email - myemail@gmail.com</p>
            </div>
            <input className='p-2 bg-[#ccd6f6] text-gray-950' type="text" placeholder='Name' name='name' />
            <input className='my-4 p-2 bg-[#ccd6f6] text-gray-950' type="email" placeholder='Email' name='email' />
            <textarea className='p-2 bg-[#ccd6f6] text-gray-950' name="message" rows="10" placeholder='Message'></textarea>
