...
const Home = () => {
  const elements = [
    ...
    {
      type: "paragraph",
      text: "Self-taught passionate about web development, I stand out for my speed of learning and my determination to continually evolve through passion.",
      ...
      <div className="max-w-[1000px] mx-auto h-full px-8 flex flex-col justify-center">
        {elements.map((element, index) => (
          ...
          >
            ...
            {element.type === "subtitle1" && <h2>{element.text}</h2>}
            {element.type === "subtitle2" && <h2>{element.text}</h2>}
